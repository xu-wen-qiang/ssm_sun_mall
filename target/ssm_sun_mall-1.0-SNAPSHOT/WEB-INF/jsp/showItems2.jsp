...
<body>
	<div class="container">
		...
		<div class="row">
			...
			<div class="col-md-offset-10">
				<h4>
					...
					<a href="${pageContext.request.contextPath }/user/LogOut">注销</a></small>
				</h4>
			</div>
		</div>
		<!-- 按钮-->
		...
		<div class="row">
			<div class="col-md-12">
				<form
					action="${pageContext.request.contextPath }/items/addCar"
					method="post">
					<table class="table table-bordered table-hover">
						...
						<c:forEach items="${pageInfo.list}" var="item">
							<tr align="center">
								...
								<!-- 删除操作-带id参数 -->
								<td><a
									href="${pageContext.request.contextPath }/items/del?id=${item.id}"><button
								...
								<!-- 修改操作 -->	
								<td><a
									href="${pageContext.request.contextPath }/items/findOne?id=${item.id}"><button
											type="button" class="btn btn-success btn-lg">
		...
		<div class="row">
			...
			<div class="col-md-6">
				<ul class="pagination pagination-lg">
					<li><a
						href="${pageContext.request.contextPath }/items/queryItems?pn=1">首页</a></li>
					<c:if test="${pageInfo.hasPreviousPage }">
						<li><a
							href="${pageContext.request.contextPath }/items/queryItems?pn=${pageInfo.pageNum-1}"
					...
					<c:forEach items="${pageInfo.navigatepageNums }" var="nav">
						<c:if test="${nav==pageInfo.pageNum }">
							<li class="active"><a
								href="${pageContext.request.contextPath }/items/queryItems?pn=${nav}">${nav }</a></li>
						</c:if>
						<c:if test="${nav!=pageInfo.pageNum }">
							<li><a
								href="${pageContext.request.contextPath }/items/queryItems?pn=${nav}">${nav }</a></li>
					...
					<li><a
						href="${pageContext.request.contextPath }/items/queryItems?pn=${pageInfo.pages}">末页</a></li>
				</ul>
			</div>
		</div>
		...
		<div class="modal-dialog modal-lg">
			...
			<!-- 模态框的标题 -->
				...
				<form class="form-horizontal" role="form"
					action="${pageContext.request.contextPath }/items/addItems"
